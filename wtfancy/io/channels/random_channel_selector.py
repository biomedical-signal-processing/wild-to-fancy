...
def filter_non_available_channels(channel_groups,
    ...
    """
    if data_file_path is None and available_channels is None:
        raise ValueError("Must specify either 'data_file_path' or "
                         "'available_channels'.")
    if available_channels is None:
        available_channels = extract_header(data_file_path)["channel_names"]
...
class RandomChannelSelector:
    ...
    def sample(self, data_file_path=None, available_channels=None):
        """
        TODO
        ...
        """
        if data_file_path or available_channels:
